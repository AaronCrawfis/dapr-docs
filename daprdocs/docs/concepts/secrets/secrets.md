---
title: Secrets Management in Dapr
...
![Cloud Stores](/img/secrets/secrets_cloud_stores.png)
...
![Kubernetes Store](/img/secrets/secrets_kubernetes_store.png)
...
![Azure KeyVault](/img/secrets/secrets_azure_aks_keyvault.png)
